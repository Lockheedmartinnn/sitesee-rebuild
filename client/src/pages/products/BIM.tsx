    ...
    <div className="flex flex-col bg-white text-slate-900">
      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-black">
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663319993959/ffsUPZvEPSLQQVKy.mp4#t=47,97" type="video/mp4" />
          </video>
      ...
      {/* IEA Integration Video Section */}
      <section className="py-16 bg-slate-950">
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">From BIM to IEA: Seamless Integration</h2>
              <p className="text-slate-400">See how BIM data instantly powers structural analysis in the IEA tool.</p>
            </div>
