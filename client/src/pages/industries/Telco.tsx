...
import { Check, ArrowRight, BarChart, Shield, Clock, Database, Zap } from "lucide-react";
    ...
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold tracking-tight">
                Intelligent Audit Automation for Accurate and Reliable Data
              </h2>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold tracking-tight">
                Intelligent Audit Automation Made Easy and Repeatable
              </h2>
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                <FeatureItem text="Reduce Operational Costs" />
                <FeatureItem text="Improve Safety" />
                <FeatureItem text="Informed Decisions" />
                <FeatureItem text="End-to-End Solution" />
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-black text-white relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-12">Why SiteSee for Telco?</h2>
