          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/products/iea" className="text-muted-foreground hover:text-primary transition-colors">IEA</Link></li>
                <li><Link href="/products/ieme" className="text-muted-foreground hover:text-primary transition-colors">IEME</Link></li>
                <li><Link href="/products/bim" className="text-muted-foreground hover:text-primary transition-colors">BIM Catalogue</Link></li>
                <li><Link href="/products/capture" className="text-muted-foreground hover:text-primary transition-colors">Capture</Link></li>
                <li><Link href="/products/ai-analysis" className="text-muted-foreground hover:text-primary transition-colors">AI Analysis</Link></li>
                <li><Link href="/products/scale-points" className="text-muted-foreground hover:text-primary transition-colors">Scale Points</Link></li>
                <li><Link href="/products/pilot-companion" className="text-muted-foreground hover:text-primary transition-colors">Pilot Companion</Link></li>
              </ul>
            </div>
